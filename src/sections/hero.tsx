    ...
    <section className={styles.heroSection}>
      <div className={styles.heroContent}>
        <div className={styles.heroContentLeft}>
          ...
          <p className="text weight-400 size-20 gray-500">{"Leverage the power of our open-sourced SDK and easy-to-use component library to build your sticky social media app with ease"}</p>
